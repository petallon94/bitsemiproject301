...
#maparea{width: 1000px; height: 800px; background-color: #f7f7f7; margin: 30px 0;}
</style>
</head>
<body>
<div id="adminmap">
	...
	<div id="btnarea">
		<button type="button" class="ordermapbtn">매장추가</button>
		<button type="button" class="ordermapbtn">매장수정</button>
		<button type="button" class="ordermapbtn">매장삭제</button>
	</div>
	<div id="maparea"></div>
</div>
</body>
