...
<div class="admin_page_menu col-md-3" id = "admin_page_menu">  
  <ul class="ap_menu_list nav nav-tabs nav-stacked">
    <li><a href="#">메뉴관리</a></li>
    <li><a href="#">지점관리</a></li>
    <li><a href="#">회원관리</a></li>
  </ul>
...
<%}else{%>
<div class="my_page_menu col-md-3" id = "my_page_menu">  
  <ul class="mp_menu_list nav nav-tabs nav-stacked">
