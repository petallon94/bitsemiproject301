...
{%>
	...
	<div class="container" id="mappagination">
	  ...
	  if(startPage>1)
		{%>
	    <li class="page-item mappage"><a class="page-link" href="index.jsp?main=map/map.jsp?pageNum=<%=startPage-1%>#mappage">이전</a></li>
	    <%}
	  for(int i=startPage;i<=endPage;i++)
		{
		  String url="index.jsp?main=map/map.jsp?pageNum="+i;//이동할 페이지 추가
			if(i==currentPage)
			{%>
				<li class="page-item mappage"><a class="page-link" href="<%=url%>#mappage"><%=i%></a></li>
			<%}else{%>
				<li class="page-item mappage"><a class="page-link" href="<%=url%>#mappage"><%=i%></a></li>
			<%}
		}
	  ...
	  if(endPage<totalPage)
		{%>
			<li class="page-item mappage"><a class="page-link" href="index.jsp?main=map/map.jsp?pageNum=<%=endPage+1%>#mappage">다음</a></li>
		<%}
	%>
	  </ul>
	</div>
